var datePicker = function () {
    ...
    if ($("#inSessionDateList").length) {
        availableDates = $("#inSessionDateList").val().split(",");
    }

    //set the date format
    function available(date) {
        var f = $.datepicker.formatDate('yymmdd', date)
    ...
    //On select date in the calendar
    function selectedDate(date) {
        //window.location.assign(window.location.origin + "/LegislativeInformation/LegislativeActivity?sessionDate=" + date);    
        window.open("http://clerk.house.gov/floorsummary/floor.aspx?day=" + date, "_blank");
    }
